...
export const PATIENT_I18N: Record<LanguageCode, LocalizedUI> = {
  hi: {
    ...
    wellnessTitle: "शारीरिक व्यायाम",
    wellnessSubtitle: "कुर्सी पर बैठे-बैठे आरामदायक व स्फूर्तिदायक हल्का व्यायाम",
  ...
  as: {
    ...
    wellnessTitle: "শাৰীৰিক ব্যায়াম",
    wellnessSubtitle: "আৰামদায়ক বহা ব্যায়াম আৰু সুস্থতা",
  ...
  bn: {
    ...
    wellnessTitle: "শারীরিক ব্যায়াম",
    wellnessSubtitle: "চেয়ারে বসে সহজ ও আরামদায়ক ব্যায়াম",
  ...
  mni: {
    ...
    wellnessSubtitle: "ফমদুনা তৌবা অরাইবা অমসুং নুংঙাইরবা এক্সরসাইজ",
  ...
  nag: {
    ...
    wellnessTitle: "Physical Exercise",
    wellnessSubtitle: "Chair te gentle exercise aru stretching",
  ...
  es: {
    ...
    wellnessTitle: "Ejercicio Físico",
    wellnessSubtitle: "Suaves y reconfortantes ejercicios sentada",
  ...
  en: {
    ...
    wellnessTitle: "Physical Exercise",
    wellnessSubtitle: "Joyful, seated movements to boost circulation & alertness",
